        ...
        <div class="row d-flex  align-items-start">
            <div class="col-md-11">
                ...
                <ul>
                    ...
                    <li><span class="title">Better Release Radar</span> looks at the last 3 albums and singles released by each artist you follow and if they've been released within the last month, they will be added to your playlist.</li>
                </ul>
