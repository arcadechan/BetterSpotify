<template>
    <div>
        ...
        <div v-if="generation == 'artistsRetrieved' || generation == 'albumsRetrieved'">
            ...
            <button @click="artistGalleryOpen = !artistGalleryOpen" class="d-block btn btn-dark mx-auto" type="button" data-toggle="collapse" data-target="#artist-gallery-container" aria-expanded="false" aria-controls="artist-gallery-container">
                {{ artistGalleryOpen ? 'Hide' : 'Show' }} Artist List
            </button>

            <div id="artist-gallery-container" class="col-12 p-0 mx-auto my-4 show">
                <div id="artists-gallery" class="col-12 p-0">
